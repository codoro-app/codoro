...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| T0 (pre-code) | Clerk password policy configured and **recorded** (~~MFA config moves to 5.1 — it needs Pro, see B1~~ cut 2026-09-08, see the B1 and C1 updates above); Clerk lockout behaviour confirmed; CodeRabbit Free enabled (~~and one Pro seat bought~~ cut 2026-09-08); Dependabot on; secret-scanning availability checked (else gitleaks); LLM key for Strix stored as an Actions secret                                            |
