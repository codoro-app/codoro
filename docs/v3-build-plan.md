...
- [ ] Lighthouse: offending dependency identified and named in an amendment; mobile performance ≥90 measured on production post-fix, or a written re-waiver citing what the dependency swap would break
